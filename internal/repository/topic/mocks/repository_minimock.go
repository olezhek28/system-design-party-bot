...
//go:generate minimock -i github.com/olezhek28/system-design-party-bot/internal/repository/topic.Repository -o ./mocks/repository_minimock.go -n RepositoryMock
...
import (
	...
	mm_topic_repository "github.com/olezhek28/system-design-party-bot/internal/repository/topic"
)
...
type RepositoryMock struct {
	...
	funcGetList          func(ctx context.Context, filter *mm_topic_repository.Query) (tpa1 []*model.Topic, err error)
	inspectFuncGetList   func(ctx context.Context, filter *mm_topic_repository.Query)
...
type RepositoryMockGetListParams struct {
	ctx    context.Context
	filter *mm_topic_repository.Query
}
...
func (mmGetList *mRepositoryMockGetList) Expect(ctx context.Context, filter *mm_topic_repository.Query) *mRepositoryMockGetList {
...
func (mmGetList *mRepositoryMockGetList) Inspect(f func(ctx context.Context, filter *mm_topic_repository.Query)) *mRepositoryMockGetList {
...
func (mmGetList *mRepositoryMockGetList) Return(tpa1 []*model.Topic, err error) *RepositoryMock {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("RepositoryMock.GetList mock is already set by Set")
	}
	...
	mmGetList.defaultExpectation.results = &RepositoryMockGetListResults{tpa1, err}
	return mmGetList.mock
}

//Set uses given function f to mock the Repository.GetList method
func (mmGetList *mRepositoryMockGetList) Set(f func(ctx context.Context, filter *mm_topic_repository.Query) (tpa1 []*model.Topic, err error)) *RepositoryMock {
	if mmGetList.defaultExpectation != nil {
...
// Then helper
func (mmGetList *mRepositoryMockGetList) When(ctx context.Context, filter *mm_topic_repository.Query) *RepositoryMockGetListExpectation {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("RepositoryMock.GetList mock is already set by Set")
	}
...
func (e *RepositoryMockGetListExpectation) Then(tpa1 []*model.Topic, err error) *RepositoryMock {
	e.results = &RepositoryMockGetListResults{tpa1, err}
	return e.mock
}
